    ...
    <div className="min-h-screen bg-base-200">
      <div className="drawer lg:drawer-open">
          ...
          <div className="sticky top-0 z-30 flex h-16 items-center gap-4 border-b border-base-200 bg-base-100/80 backdrop-blur px-4 lg:px-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="dropdown dropdown-end">
                ...
                <ul tabIndex={0} className="dropdown-content menu p-2 shadow-lg bg-base-100 rounded-box w-48 border border-base-200 mt-2">
                  <li><Link href="/account/profile" className="text-sm">Profile</Link></li>
                  <li><button onClick={() => signOut()} className="text-sm text-error">Sign Out</button></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div className="drawer-side">
          ...
          <aside className="flex h-full w-64 flex-col bg-base-100 border-r border-base-200">
            <div className="flex h-16 items-center gap-2 border-b border-base-200 px-6">
              ...
              <button onClick={() => setSidebarOpen(false)} className="btn btn-ghost btn-sm ml-auto lg:hidden">
                <X className="w-4 h-4" />
              </button>
            </div>
