...
function HeroSection({ ceoName, ceoTitle, ceoHeroImage, ceoHeroBadge, ceoHeroTitle, ceoHeroDesc }: { ceoName: string; ceoTitle: string; ceoHeroImage: string; ceoHeroBadge: string; ceoHeroTitle: string; ceoHeroDesc: string }) {
  ...
  return (
    <section ref={ref} className="relative h-[70vh] min-h-[500px] flex items-center justify-center overflow-hidden">
      <motion.div className="absolute inset-0" style={{ y: bgY }}>
        <Image
          src={ceoHeroImage || "https://images.unsplash.com/photo-1559136555-9303baea8ebd?w=1920"}
          alt="CEO"
          fill
      ...
      >
        ...
        >
          {ceoHeroDesc || `The vision behind ${ceoName} &mdash; leading SIDMAB with passion and purpose.`}
        </motion.p>
        <motion.div
...
function CeoProfile({
  ceoName, ceoTitle, ceoImage, ceoBio, ceoMessage, ceoSignature, ceoProfileLabel,
}: {
  ceoName: string; ceoTitle: string; ceoImage: string; ceoBio: string; ceoMessage: string; ceoSignature: string; ceoProfileLabel: string
}) {
  const ref = useRef<HTMLDivElement>(null)
...
function CTASection({ ceoCtaTitle, ceoCtaDesc }: { ceoCtaTitle: string; ceoCtaDesc: string }) {
  const ref = useRef<HTMLDivElement>(null)
...
export default function CeoClient({
  ...
  ceoCtaTitle, ceoCtaDesc, ceoHeroImage, ceoHeroBadge, ceoHeroTitle, ceoHeroDesc, ceoProfileLabel,
}: {
  ceoName: string; ceoTitle: string; ceoImage: string; ceoBio: string; ceoMessage: string; ceoSignature: string
  ceoCtaTitle: string; ceoCtaDesc: string; ceoHeroImage: string; ceoHeroBadge: string; ceoHeroTitle: string; ceoHeroDesc: string; ceoProfileLabel: string
}) {
  return (
    <>
      <HeroSection ceoName={ceoName} ceoTitle={ceoTitle} ceoHeroImage={ceoHeroImage} ceoHeroBadge={ceoHeroBadge} ceoHeroTitle={ceoHeroTitle} ceoHeroDesc={ceoHeroDesc} />
      <CeoProfile
        ceoName={ceoName}
        ceoTitle={ceoTitle}
        ceoImage={ceoImage}
        ...
        ceoProfileLabel={ceoProfileLabel}
      />
      <CTASection ceoCtaTitle={ceoCtaTitle} ceoCtaDesc={ceoCtaDesc} />
    </>
  )
}
